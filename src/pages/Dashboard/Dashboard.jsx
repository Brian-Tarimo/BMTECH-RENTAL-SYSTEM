...
<div className="flex justify-between items-center mb-10">
  ...
  <button
    ...
    className="bg-emerald-500 hover:bg-emerald-600 px-5 py-3 rounded-xl font-semibold shadow-lg"
  >
    Manage Requests
  </button>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
  ...
  <div className="bg-white/10 backdrop-blur-lg border border-white/10 p-6 rounded-2xl shadow-lg hover:scale-[1.02] transition">
...
```
        ...
        ```
{/* UNIT REQUESTS */}
<div className="bg-white/10 backdrop-blur-lg border border-white/10 p-6 rounded-2xl mb-10">
